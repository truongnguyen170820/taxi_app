...
import 'package:taxi_app/view/ride_picker_page.dart';
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    SizedBox(
                      ...
                      height: 50,
                      child: Center(
                        child: Image.asset(getAssetsImage("ic_location_black.png")),
                      ),
                    ),
                    Positioned(
                      right: 0,
                      ...
                      height: 50,
                      child: Center(
                        child: Image.asset(getAssetsImage("ic_remove_x.png")),
                      ),
                    ),
                    Padding(
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    SizedBox(
                      ...
                      height: 50,
                      child: Center(
                        child: Image.asset(getAssetsImage("ic_map_nav.png")),
                      ),
                    ),
                    Positioned(
                      right: 0,
